...
from wpaudit.providers import get_provider
from wpaudit.providers.aws.authentication_strategy import AWSCredentials
from wpaudit.providers.base.authentication_strategy import AuthenticationException
from wpaudit.providers.base.authentication_strategy_factory import get_authentication_strategy
...
class TestAWSProviderClass(unittest.TestCase):
    @mock.patch("wpaudit.providers.aws.authentication_strategy.boto3")
    @mock.patch("wpaudit.providers.aws.authentication_strategy.get_caller_identity")
    ...
    @mock.patch("wpaudit.providers.aws.facade.base.get_aws_account_id")
    @mock.patch("wpaudit.providers.aws.provider.get_aws_account_id")
    @mock.patch("wpaudit.providers.aws.provider.get_partition_name")
