...
import unittest
from wpaudit.core.console import set_logger_configuration, print_debug
from wpaudit.core.rule import Rule
from wpaudit.core.ruleset import Ruleset
...
class TestScoutRulesRuleset(unittest.TestCase):
    ...
    @mock.patch("wpaudit.core.ruleset.print_error")
    ...
    @mock.patch("wpaudit.core.ruleset.print_exception")
    ...
    def test_path_for_cloud_providers(self):
        ...
        assert (os.path.samefile(target.rules_data_path, './wpaudit/providers/aws/rules'))

        target = Ruleset(cloud_provider='azure', filename=self.test_ruleset_001)
        assert (os.path.samefile(target.rules_data_path, './wpaudit/providers/azure/rules'))

        target = Ruleset(cloud_provider='gcp', filename=self.test_ruleset_001)
        assert (os.path.samefile(target.rules_data_path, './wpaudit/providers/gcp/rules'))

    def test_path_for_ruletypes(self):
        rpath = "./wpaudit/providers/aws/rules/"
    ...
    @mock.patch("wpaudit.core.ruleset.prompt_yes_no")
