...
from wpaudit.providers.azure.facade.base import AzureFacade
from wpaudit.providers.azure.resources.aad.base import AAD
from wpaudit.providers.azure.resources.rbac.base import RBAC
from wpaudit.providers.azure.resources.keyvault.base import KeyVaults
from wpaudit.providers.azure.resources.network.base import Networks
from wpaudit.providers.azure.resources.securitycenter.base import SecurityCenter
from wpaudit.providers.azure.resources.sqldatabase.base import Servers
from wpaudit.providers.azure.resources.storageaccounts.base import StorageAccounts
from wpaudit.providers.azure.resources.virtualmachines.base import VirtualMachines
from wpaudit.providers.base.services import BaseServicesConfig
from wpaudit.providers.azure.resources.appservice.base import AppServices

# Try to import proprietary services
try:
    from wpaudit.providers.azure.resources.private_appgateway.base import ApplicationGateways
except ImportError:
    pass
try:
    from wpaudit.providers.azure.resources.private_rediscache.base import RedisCaches
except ImportError:
    pass
try:
    from wpaudit.providers.azure.resources.private_loadbalancer.base import LoadBalancers
except ImportError:
    pass
