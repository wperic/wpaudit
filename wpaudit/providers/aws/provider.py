...
from wpaudit.core.console import print_error, print_exception, print_debug
from wpaudit.providers.aws.services import AWSServicesConfig
from wpaudit.providers.aws.resources.vpc.base import put_cidr_name
from wpaudit.providers.aws.utils import ec2_classic, get_aws_account_id
from wpaudit.providers.base.configs.browser import combine_paths, get_object_at, get_value_at
from wpaudit.providers.base.provider import BaseProvider
from wpaudit.utils import manage_dictionary
from wpaudit.providers.aws.utils import get_partition_name
