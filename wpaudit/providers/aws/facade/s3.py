...
from wpaudit.providers.aws.facade.utils import AWSFacadeUtils
from wpaudit.providers.utils import run_concurrently, get_and_set_concurrently
...
class S3Facade(AWSBaseFacade):
    async def get_buckets(self):
        try:
            ...
            # as per https://github.com/wperic/wpaudit/issues/727
            buckets = []
            exception = None
            ...
            for region in region_list:
                try:
                    ...
                    exception = None  # Fix for https://github.com/wperic/wpaudit/issues/916#issuecomment-728783965
                    break
            if not buckets:
                if exception:
